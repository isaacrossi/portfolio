<section class="bg-light px-4 md:px-8 lg:px-16 pt-10 pb-14 md:pt-20 md:pb-24">
  ...
  <div class="container bg-light flex flex-col md:flex-row justify-between md:items-start items-stretch">
    <h2 class="font-heading text-5xl md:text-6xl tracking-wide uppercase text-dark">Work</h2>

    <div class="flex flex-col justify-between bg-dark text-light px-4 pb-4 md:pb-6 rounded-tr-4xl md:w-2/5 w-8/12">
    ...
    <div class="flex flex-col justify-between self-end bg-dark text-light px-4 pb-4 md:pb-6 rounded-tr-4xl md:w-2/5 w-8/12 mt-14">
